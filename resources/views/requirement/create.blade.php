    ...
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Crear una nueva solicitud</h4>
            <form class="forms-sample material-form bordered" method="POST" action="{{ route('login') }}">
                @csrf
                <input type="hidden" required="required" name="user_id">
                ...
                <div class="button-container text-center">
                    <a type="button" class="button btn btn-primary"><span>Enviar solicitud</span></a>
                </div>
            </form>
      </div>
    </div>
